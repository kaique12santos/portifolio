...
const portfolioContent = {
  pt: {
    rpg: {
      // NAV
      "nav-about": "Pergaminho", "nav-projects": "Quests", "nav-skills": "Habilidades", "nav-journey": "Jornada", "nav-contact": "Invocar",
      ...
      "rank-1": "O Guardião dos Laboratórios", "rank-2": "O Grimório da Guilda 2.0 (GED)", "rank-3": "A Rede de Energia Arcana", "rank-4": "O Forjador de Runas Sólidas", "rank-5": "Planejando a próxima Quest",
      "future-title": "A Jornada Continua", "future-desc": "Este espaço está reservado para a próxima quest que forjaremos juntos. O próximo grimório de código, o próximo feitiço de interface.", "future-btn": "Mande sua Quest",
      ...
      "j-date-2": "2025 – Chegando ao Fim...", "j-title-2": "Backend Lead & Project Leader — SGPI", "j-desc-2": "Liderança técnica e de equipe no desenvolvimento do Sistema de Gestão de Projetos Integradores. Responsável por arquitetura, revisão de código e entregas.",
      ...
      "j-date-4": "2024 – Jun 2027 (Previsão)", "j-title-4": "Ingresso em DSM — Fatec Zona Leste", "j-desc-4": "Início da formação como Tecnólogo em Desenvolvimento de Software Multiplataforma, com foco em desenvolvimento web, mobile e Desktop.",
    ...
    normal: {
      // NAV
      "nav-about": "Sobre Mim", "nav-projects": "Projetos", "nav-skills": "Competências", "nav-journey": "Trajetória", "nav-contact": "Contato",
      ...
      "rank-1": "Projeto Principal", "rank-2": "Refatoração Acadêmica", "rank-3": "Design Patterns", "rank-4": "Qualidade de Software", "rank-5": "Em Planejamento",
      "future-title": "Próximos Passos", "future-desc": "Este espaço está reservado para o meu próximo desafio profissional. Um novo sistema robusto ou uma arquitetura escalável.", "future-btn": "Vamos Conversar",
      ...
      "j-date-2": "2025 – Fim do Ciclo", "j-title-2": "Backend Lead & Project Leader — SGPI", "j-desc-2": "Liderança técnica e gestão de equipe no desenvolvimento do Sistema de Gestão de Projetos Integradores. Responsável pela arquitetura e code review.",
      ...
      "j-date-4": "2024 – Jun 2027 (Previsão)", "j-title-4": "Graduação em DSM — Fatec Zona Leste", "j-desc-4": "Formação como Tecnólogo em Desenvolvimento de Software Multiplataforma, com foco em engenharia de software e desenvolvimento web/mobile.",
  ...
  en: {
    rpg: {
      // NAV
      "nav-about": "Scroll", "nav-projects": "Quests", "nav-skills": "Skills", "nav-journey": "Journey", "nav-contact": "Summon",
      ...
      "rank-1": "The Guardian of the Labs", "rank-2": "The Guild's Grimoire 2.0", "rank-3": "The Arcane Energy Network", "rank-4": "The Forger of Solid Runes", "rank-5": "Planning the next Quest",
      "future-title": "The Journey Continues", "future-desc": "This space is reserved for the next quest we will forge together. The next code grimoire, the next interface spell.", "future-btn": "Send your Quest",
      ...
      "j-date-2": "2025 – Reaching the End...", "j-title-2": "Backend Lead & Project Leader — SGPI", "j-desc-2": "Technical and team leadership in developing the Integrator Projects Management System. Responsible for architecture, code review, and deliveries.",
      ...
      "j-date-4": "2024 – Jun 2027 (Expected)", "j-title-4": "Enrolled in DSM — Fatec ZL", "j-desc-4": "Started degree in Multiplatform Software Development, focusing on web, mobile, and desktop development.",
    ...
    normal: {
      // NAV
      "nav-about": "About Me", "nav-projects": "Projects", "nav-skills": "Competencies", "nav-journey": "Experience", "nav-contact": "Contact",
      ...
      "rank-1": "Main Project", "rank-2": "Academic Refactoring", "rank-3": "Design Patterns", "rank-4": "Software Quality", "rank-5": "In Planning",
      "future-title": "Next Steps", "future-desc": "This space is reserved for my next professional challenge. A new robust system or a scalable architecture.", "future-btn": "Let's Talk",
      ...
      "j-date-2": "2025 – End of Cycle", "j-title-2": "Backend Lead & Project Leader — SGPI", "j-desc-2": "Technical and team leadership in developing the Integrator Projects Management System. Responsible for architecture and code reviews.",
      ...
      "j-date-4": "2024 – Jun 2027 (Expected)", "j-title-4": "Software Dev Degree — Fatec ZL", "j-desc-4": "Degree in Multiplatform Software Development, focusing on software engineering and web/mobile development.",
